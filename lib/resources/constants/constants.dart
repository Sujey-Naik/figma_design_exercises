...
class PaddingConstants {
  ...
  static EdgeInsetsGeometry errorTextTopPadding =
...
class SizedBoxConstants {
  ...
  static SizedBox sizedBoxBetweenErrorIconMessage = const SizedBox(
    width: 4.0,
  );
  static SizedBox sizedBoxBeforeErrorIcon = const SizedBox(
    width: 12.0,
  );
  static SizedBox emptySizedBox = const SizedBox();
}
